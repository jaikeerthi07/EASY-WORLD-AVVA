  ...
  const handlePrintQuotation = (quotation) => {
    ...
    if (printWindow) {
      ...
      const printContent = `
        ...
        <body>
          <div class="header">
            <img src="/avva-logo.jpeg" class="company-logo" alt="EazyWorld Logo">
            <div class="company-name">EazyWorld</div>
          ...
          <div class="signature">
            <div>
              <p><strong>For EazyWorld</strong></p>
          ...
          <div style={{ ...styles.modal, maxWidth: '900px' }} ref={viewModalRef}>
            ...
            <div style={styles.modalContent}>
              ...
              <div style={styles.viewCompanyHeader}>
                <img src="/avva-logo.jpeg" alt="EazyWorld Logo" style={{ maxWidth: '120px', marginBottom: '10px' }} />
