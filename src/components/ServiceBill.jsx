...
const ServiceBill = () => {
        ...
        <body>
          <div id="billPaper">
            <div class="bill-header">
              <img src="/avva-logo.jpeg" class="bill-logo" alt="EazyWorld Logo">
  ...
  const handleWhatsAppShare = () => {
    ...
    let message = `*EazyWorld - SERVICE BILL*\n`;
    ...
    message += `================\n`;
    message += `Thank you for choosing EazyWorld!\n`;
  ...
  return (
    <div style={baseStyles.container}>
      ...
      <div style={baseStyles.productPanel} className="no-print">
        <h2 style={baseStyles.productPanelTitle}>🔧 Create Service Bill - EazyWorld</h2>
        ...
        <div style={baseStyles.billContainer}>
          ...
          >
            <div className="bill-header">
              <img src="/avva-logo.jpeg" alt="EazyWorld Logo" style={{ maxWidth: '100px', marginBottom: '5px', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
